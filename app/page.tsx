  ...
  return (
    <main className="w-full overflow-hidden">
      ...
      >
        ...
        {/* STARS */}
        <div className="absolute top-20 left-20 text-3xl animate-pulse">
          ✨
        </div>

        <div className="absolute top-40 right-32 text-2xl animate-bounce">
          ⭐
        </div>

        <div className="absolute bottom-32 left-1/3 text-xl animate-ping">
          ✦
        </div>
      ...
      >
        ...
        {/* PARTICLES */}
        <div className="absolute top-24 left-24 text-2xl animate-pulse">
          ✨
        </div>

        <div className="absolute bottom-40 right-40 text-xl animate-ping">
          ✦
        </div>

        <div className="absolute top-1/2 left-20 text-2xl animate-bounce">
          🍃
        </div>
      ...
      >
        ...
        {/* PARTICLES */}
        <div className="absolute top-24 right-24 text-2xl animate-pulse">
          ✨
        </div>

        <div className="absolute bottom-40 left-40 text-xl animate-ping">
          ✦
        </div>

        <div className="absolute top-1/2 right-20 text-2xl animate-bounce">
          🍂
        </div>
